...
public class ArrCharOps {
    public static void main(String[] args) {
        ...
        System.out.println(arr2);  // Prints the string
        println(arr1);            // Prints an array of characters
        System.out.println(charAt(arr1,2));      
        System.out.println(indexOf(arr1,'l'));  
        System.out.println(indexOf(arr1,'l',3)); 
        System.out.println("this"+lastIndexOf(arr1, 'l'));
        System.out.println(concat(arr1, arr2));
        System.out.println(subArray(arr2, 2, 5));
    ...
    */
    ...
    public static char[] subArray(char[] arr, int beginIndex, int endIndex) {
        char[] arr2 = new char[endIndex - beginIndex]; //hamburger
     ...
     */
     ...
     public static long hashCode(char[] arr) {
        double hashCodeArr = 0;
        for (double i = 0; i < arr.length; i++) {
        hashCodeArr += charAt(arr, (int) i) * (Math.pow(7.0, (double) arr.length-(i+1)));
            
        }
        return (long) hashCodeArr;
    }
     ...
     *         0 if they are equal, and 1 if str1 is
